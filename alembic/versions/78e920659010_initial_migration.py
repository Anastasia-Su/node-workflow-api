...
Revision ID: 78e920659010
Revises: 
Create Date: 2024-05-17 11:23:09.541160
...
def upgrade() -> None:
    ...
    sa.Column('node_type', sa.Enum('START', 'MESSAGE', 'CONDITION', 'END', name='nodetypes'), nullable=True),
