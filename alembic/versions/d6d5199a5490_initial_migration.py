...
Revision ID: d6d5199a5490
Revises: d96734f4382f
Create Date: 2024-05-28 22:10:27.799375
...
revision: str = 'd6d5199a5490'
down_revision: Union[str, None] = 'd96734f4382f'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['condition_node_id'], ['condition.id'], ondelete='CASCADE', use_alter=True),
    ...
    sa.ForeignKeyConstraint(['parent_condition_edge_id'], ['condition_edge.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['parent_node_id'], ['node.id'], ondelete='SET NULL'),
    ...
    sa.Column('workflow_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['node.id'], ),
    sa.ForeignKeyConstraint(['parent_message_node_id'], ['message.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['parent_node_id'], ['node.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['workflow_id'], ['workflow.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('workflow_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['node.id'], ),
    sa.ForeignKeyConstraint(['parent_node_id'], ['message.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['workflow_id'], ['workflow.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
